                ...
                <div class="row">
                  <div class="col-md-6 mb-2 pb-2">
                    <div class="form-outline">
                        ...
                        <input type="password" autocomplete="off" id="password" name="password" class="form-control form-control-lg @error('password') is-invalid @enderror" />
                      ...
                      @enderror
                        <input type="password" autocomplete="off" id="password" name="password_confirm" class="form-control form-control-lg @error('password_confirm') is-invalid @enderror" />
