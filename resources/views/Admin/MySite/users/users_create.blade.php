      ...
      <div class="row justify-content-center align-items-center h-100">
        <div class="col-12 col-lg-9 col-xl-7">
          <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
            <div class="card-body ">
              <h3 class="mb-4 pb-2 pb-md-0 mb-md-5">UserCreate</h3>
              <form method="post" action="{{route("createUser")}}" enctype="multipart/form-data" autocomplete = "off">
                @csrf
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-4">
                        ...
                        <h6 class="mb-2 pb-1">Permission: </h6>
