    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div data-i18n="Layouts">MySite</div>
            </a>
            ...
            <ul class="menu-sub">
                ...
                <li class="menu-item">
                    <a href="{{route('CatShow')}}" class="menu-link">
                        <div data-i18n="Container">Categories</div>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="{{route('SubCatShow')}}" class="menu-link">
                        <div data-i18n="Fluid">SubCategories</div>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="{{route('productShow')}}" class="menu-link">
                        <div data-i18n="Blank">Products</div>
                    </a>
                </li>
            </ul>
        </li>
